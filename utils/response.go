...
type PaginationMeta struct {
	...
	Filter    string `json:"filter" example:"nama=hafidz"`
...
func BadRequest(c *fiber.Ctx, message, err string) error {
...
func NotFound(c *fiber.Ctx, message, err string) error {
...
func Unauthorized(c *fiber.Ctx, message, err string) error {
