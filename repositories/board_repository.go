...
func (*boardRepository) RemoveMembers(boardID uint, userIDs []uint) error {
	if len(userIDs) == 0 {
		return nil
	}
...
func (*boardRepository) FindAllByUserPagination(userPublicID, filter, sort string, limit, offset int) ([]models.Board, int64, error) {
	var board []models.Board
	var total int64
